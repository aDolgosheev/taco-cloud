...
import ru.dolgosheev.tacocloud.Ingredient;
...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
    ...
    public IngredientByIdConverter() {
        ...
        ingredientMap.put("GRBF", new Ingredient("GRBF", "Groound Beef", Ingredient.Type.PROTEIN));
        ...
        ingredientMap.put("SLCA", new Ingredient("SLCA", "Salsa", Ingredient.Type.SAUCE));
